...
{
	{GPIOB,RCC_AHBENR_GPIOBEN,GPIO_PIN_2,GPIO_MODE_OUTPUT_PP,GPIO_NOPULL},		// SWITCH_COOLING
	...
	//{GPIOB,RCC_AHBENR_GPIOBEN,GPIO_PIN_12,GPIO_MODE_OUTPUT_PP,GPIO_NOPULL}		// SWITCH_CHARGE_BYPASS
};
